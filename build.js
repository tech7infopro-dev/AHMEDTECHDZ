...
// ============================================
// 📁 COPY STATIC DIRECTORIES (IMAGES, ASSETS)
// ============================================
...
// المجلدات الثابتة التي يجب نسخها
const staticDirs = [
...
console.log(`  - Static directories copied: ${staticDirs.filter(d => fs.existsSync(path.join(__dirname, d))).length}`);
