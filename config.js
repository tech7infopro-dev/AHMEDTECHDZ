...
// ⚠️ IMPORTANT: Password is set via Firebase Console only!
// ============================================
...
// ❌ NO DEFAULT PASSWORD - Must be set via Firebase Console
const DEFAULT_OWNER = {
    id: DEFAULT_OWNER_NAME,
    name: DEFAULT_OWNER_NAME,
    email: DEFAULT_OWNER_EMAIL,
    password: null,  // Password set via Firebase Auth only
    role: "owner",
...
const CONFIG = {
    ...
    // ============================================
    // DEFAULT ACCOUNTS - EMAIL BASED (NO PASSWORDS STORED)
    // ============================================
    DEFAULT_USERS: [DEFAULT_OWNER],

    // ❌ NO DEFAULT PASSWORDS - All passwords set via Firebase Auth
    DEFAULT_PASSWORDS: {},
