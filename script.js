/* ============================================
   ...
   ============================================ */
// ============================================
// SECURE CONSOLE - FILTER SECRETS ONLY
// ============================================

const isProduction = window.location.hostname === 'ahmedtechdz.vercel.app' || 
...
function filterArgs(args) {
    return args.map(arg => {
        if (typeof arg === 'string' && containsSecret(arg)) {
            return '[FILTERED]';
        }
        ...
        if (typeof arg === 'object' && arg !== null) {
            ...
            for (const [key, value] of Object.entries(arg)) {
                ...
                const isSensitiveKey = 
                    keyLower.includes('salt') ||
                    keyLower.includes('secret') ||
                    keyLower.includes('key') ||
                    keyLower.includes('password') ||
                    keyLower.includes('token') ||
                    keyLower.includes('hash') ||
                    keyLower.includes('encryption') ||
                    (keyLower.includes('config') && typeof value === 'object');
                ...
                if (isSensitiveKey) {
                    ...
                    filtered[key] = filterArgs([value])[0];
                } else {
                    filtered[key] = value;
                }
            }
...
if (isProduction) {
    console.log = function(...args) {
        _console.log.apply(console, filterArgs(args));
    };
    
    console.warn = function(...args) {
        _console.warn.apply(console, filterArgs(args));
    };
    
    console.error = function(...args) {
        _console.error.apply(console, filterArgs(args));
    };
    
    console.info = function(...args) {
        _console.info.apply(console, filterArgs(args));
    };
}
